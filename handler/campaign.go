...
// handler ke service
// service yang menentukan repostory mana yang di-call
// reposotory : get all, get by user_id
// db
...
func (h *campaignHandler) GetCampaign(c *gin.Context) {
	//handler : maping id yang di url ke struct input => service, call formatter
	// service: inpoutnya struct input=> menangkap id di url, manggil repo
...
// tangkap parameter user ke input
// ambil current user
// panggil service, parameternya input struct
// panggil repository untuk simpan data ke database
